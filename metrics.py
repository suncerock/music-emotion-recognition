...
def compute_metric(output, target, music_id):
    output_arousal, output_valence = output
    target_arousal, target_valence = target
    results = dict()
    results['rmse_segments_arousal'], results['rmse_songs_arousal'] = compute_rmse(output_arousal, target_arousal, music_id)
    results['r2_segments_arousal'], results['r2_songs_arousal'] = compute_r2(output_arousal, target_arousal, music_id)
    results['rmse_segments_valence'], results['rmse_songs_valence'] = compute_rmse(output_valence, target_valence, music_id)
    results['r2_segments_valence'], results['r2_songs_valence'] = compute_r2(output_valence, target_valence, music_id)
    return results
